" Vim syntax file
" Language:	.reg files (modified from the C language support file).

" Remove any old syntax stuff hanging around
syn clear

" A bunch of useful C keywords
syn keyword	regStatement	BEGIN DEFINE REGISTRY END DATA
syn keyword	cStatement	goto break return continue asm
syn keyword	regAction	LOOP STUB RETVAL
...
if !exists("did_c_syntax_inits")
  ...
  hi link regStatement  Statement
